...
public class Skylar : Character
{
    ...
    void Start()
    {
        //this.gameObject.GetComponent<PlayerScript>().isSkylar = true;
    }
    ...
    public override void Init()
    {
        ...
        player.barks = GameObject.Find("SoundLibrary").GetComponent<SoundLibrary>().skylarAudio;
    ...
    public override void Attack()
    {
            ...
            if (canAttack && !player.inDungeon)
            {
                if (gamePad.IsConnected)
                {
                    ...
                    if (rightStickX != 0.0f || rightStickY != 0.0f)
                    {
                        ...
                        temp.GetComponent<Bullet>().UseTheForce(m_direction, 20.0f);
        ...
        {
            Debug.Log("CRASH PREVENTED");//Probably from the input/gampad
        }
